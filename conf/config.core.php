...
/**
 * Call the selected module's meta.php file if present
 */
...
/**
 * Convert an ordinary string into something uri friendly
 * @param string URI to convert
 * @return string The friendly version
 */
function urlify($str){
