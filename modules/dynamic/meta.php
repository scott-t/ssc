...
if($database->query() && $data = $database->getAssoc()){
	...
	if(file_exists($path.'rss-'.$data['id'].'.xml'))
		echo '<link rel="alternate" type="application/rss+xml" title="Subscribe using RSS 2.0" href="',$sscConfig_webPath,'/modules/dynamic/rss-',$data['id'],'.xml" />';
	if(file_exists($path.'atom-'.$data['id'].'.xml'))
		echo '<link rel="alternate" type="application/atom+xml" title="Subscribe using Atom 1.0" href="',$sscConfig_webPath,'/modules/dynamic/atom-',$data['id'],'.xml" />';
